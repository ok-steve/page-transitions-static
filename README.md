# Page Transitions Travelapp (Static)

This demo adapts the original example to use static HTML pages instead of Vue, showing it's possible to add native-like animations using progressive enhancement techniques.

For this demo I used Jekyll, Turbolinks, Stimulus, and morphdom. 
